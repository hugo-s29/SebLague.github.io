...
function createColorRangeRGB(c1, c2, count) {
  ...
  for (let i = 0; i < count; i++) {
    tmpColor = GColor();
    tmpColor.r = c1.r + (i * (c2.r - c1.r)) / count;
    tmpColor.g = c1.g + (i * (c2.g - c1.g)) / count;
    tmpColor.b = c1.b + (i * (c2.b - c1.b)) / count;
...
function colorRange(c1, c2, count) {
  ...
  const range = createColorRangeRGB(rgbC1, rgbC2, count);

  return range.map((c) => rgbToHex(c));
}
