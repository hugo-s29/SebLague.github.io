//* CODE FROM https://github.com/toolness/friendly-error-fellowship/blob/gh-pages/experiments/typescript/p5.d.ts
...
declare class p5 {
   ...
   */
  background(
    v1: number | string | p5.Color | p5.Image,
    v2?: number,
    v3?: number,
    a?: number
  ): void;
